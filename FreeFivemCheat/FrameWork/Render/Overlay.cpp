...
namespace FrameWork
{
	...
	void Overlay::Initialize()
	{
		...
		hWindow = CreateWindowEx(WS_EX_TOPMOST | WS_EX_TOOLWINDOW | WS_EX_TRANSPARENT, WindowClass.lpszClassName, WindowClass.lpszMenuName, WS_POPUP | WS_VISIBLE, wTargetWindowRect.left, wTargetWindowRect.top, wTargetWindowRect.Width(), wTargetWindowRect.Height(), NULL, NULL, GetModuleHandle(NULL), NULL);
